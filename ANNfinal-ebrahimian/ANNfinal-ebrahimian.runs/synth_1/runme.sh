...
HD_PWD='D:/Download/rcs/ANNfinal-ebrahimian/ANNfinal-ebrahimian.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log artificial_neural_network.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source artificial_neural_network.tcl
